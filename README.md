...
# Bare Metal I<sup>2</sup>C Drivers for the PIC16F18076 Family of MCUs

In this example, bare metal I<sup>2</sup>C drivers for the MSSP peripheral on the PIC16F18076 family of MCUs will be created.

Additionally this project is a direct port of the ["Bare Metal I<sup>2</sup>C Drivers for the PIC16F15244 Family of MCUs"](https://github.com/microchip-pic-avr-examples/pic16f15244-bare-metal-i2c-mplab) to easily work with the PIC16F18076 family of microcontrollers.

## Software Used

- [MPLAB® X IDE v6.0.0 or newer](https://www.microchip.com/en-us/tools-resources/develop/mplab-x-ide?utm_source=GitHub&utm_medium=TextLink&utm_campaign=MCU8_MMTCha_pic16f18076&utm_content=pic16f18076-bare-metal-i2c-mplab)
  - [PIC16F1xxxx_DFP v1.14.187](https://packs.download.microchip.com/)
- [MPLAB XC8 v2.40 or newer compiler](https://www.microchip.com/en-us/tools-resources/develop/mplab-xc-compilers?utm_source=GitHub&utm_medium=TextLink&utm_campaign=MCU8_MMTCha_pic16f18076&utm_content=pic16f18076-bare-metal-i2c-mplab)

## Hardware Used

To run this project, a PIC16F18076 is required, but other devices within the same device family and with an MSSP should also function with *adjustments to the pin assignments*.

This project was tested and built on a PIC16F18076 Curiosity Nano.

- [PIC16F18076 Curiosity Nano (EV09Z19A)](https://www.microchip.com/en-us/development-tool/EV53Z50A?utm_source=GitHub&utm_medium=TextLink&utm_campaign=MCU8_MMTCha_pic16f18076&utm_content=pic16f18076-bare-metal-i2c-mplab)
- [Curiosity Nano Base for Click boards™ (AC164162)](https://www.microchip.com/en-us/development-tool/AC164162?utm_source=GitHub&utm_medium=TextLink&utm_campaign=MCU8_MMTCha_pic16f18076&utm_content=pic16f18076-bare-metal-i2c-mplab)

Alternatively, these tools should also be compatible:

- [Curiosity LPC board (DM164137)](https://www.microchip.com/en-us/development-tool/DM164137?utm_source=GitHub&utm_medium=TextLink&utm_campaign=MCU8_MMTCha_pic16f18076&utm_content=pic16f18076-bare-metal-i2c-mplab)
- [PIC16F18045/PIC16F18044 MCU in a 20-pin DIP package](https://www.microchip.com/en-us/products/microcontrollers-and-microprocessors/8-bit-mcus/pic-mcus/pic16f18076?utm_source=GitHub&utm_medium=TextLink&utm_campaign=MCU8_MMTCha_pic16f18076&utm_content=pic16f18076-bare-metal-i2c-mplab)
...
This example uses pins RC4 and RC3 for I<sup>2</sup>C communication. These are the default pins used on the Curiosity Nano Adapter board for I<sup>2</sup>C.
...
| ------------------- | --------
| void initI2CPins(void) | Initializes the I<sup>2</sup>C pins for the MSSP. Uses RC4 and RC3.
